...
## About
This is an endpoint to count the number of frames in an MP3 version 1 layer 3 file. I decided to just use Node without express or a server framework out of curiousity because I have never done that.
...
Add a .env file with `PORT={port}` if you'd like to specify a port or the server will default to 5001
